...
class Strategy:
    ...
    def apply_sell(bitget_data_util: BitgetDataUtil, data_frame: pandas.DataFrame) -> pandas.DataFrame:
        ...
        query = "((" + DataFrameColum.PERCENTAGE_PROFIT.value + " < " + str(value_limit_pctg) + ") and (" + DataFrameColum.LOOK.value + " == 'headdress!'))" 
        ...
        """********************************************** OPCION 2 **********************************************"""
        query = "((" + DataFrameColum.PERCENTAGE_PROFIT.value + " > " + str(value_limit_pctg) + ") and (" + DataFrameColum.PERCENTAGE_PROFIT.value + " < " + DataFrameColum.STOP_LOSS.value + "))"  #! Es muy buena 
        ...
        for ind in filtered_data_frame.index:
            cntrl_profit_crrnt = float(filtered_data_frame.loc[ind,DataFrameColum.PERCENTAGE_PROFIT.value]) - 0.3
