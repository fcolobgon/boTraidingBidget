...
class Strategy:
    ...
    def apply_buy(self, bitget_data_util: BitgetDataUtil, data_frame: pandas.DataFrame) -> pandas.DataFrame:
        ...
        filtered_data_frame = Strategy.updating_macd_modif(bitget_data_util=bitget_data_util, config_macd = config_macd, data_frame = filtered_data_frame, prices_history_dict = prices_history_dict, ascending_count = 2, asc_count_chart=2)
